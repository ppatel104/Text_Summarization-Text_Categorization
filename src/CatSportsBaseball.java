...
public class CatSportsBaseball {
    
    
    int score;
    String[] sp_baseball = {  "Ability", "Accuracy", "Activated",
    ...
    int getBaseballScore(String word){
    
        for (String sp_baseball1 : sp_baseball) {
    
//            System.out.print(comp1 +" "+word);
            if(sp_baseball1.equalsIgnoreCase(word)){
                score= 1;
                break;
            }else{
